...
class CoLabs_Twitter extends WP_Widget {
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <?php 
		echo $before_title;
		if ($title) {echo $title; }else { _e('Twitter');}
		echo $after_title;
		?>
              
        <div class="back"><ul id="twitter_update_list_<?php echo $unique_id; ?>"><li></li></ul>
        <p><?php _e('Follow','colabsthemes'); ?> <a href="http://twitter.com/<?php echo $username; ?>"><strong>@<?php echo $username; ?></strong></a> <?php _e('on Twitter','colabsthemes'); ?></p></div><div class="clear"></div>
