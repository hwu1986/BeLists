       ...
       ?>  
 		...
 		<div id="tabs">
            ...
            <ul class="colabsTabs">
                ...
                <?php if ($order <> "latest" && !$latest == "on") { ?><li class="latest"><a href="#tab-latest"><?php _e('Latest', 'colabsthemes'); ?></a></li><?php } ?>
            ...
            <div class="boxes box inside">
                ...
                <ul id="tab-latest" class="list">
                    <?php if ( function_exists('colabs_tabs_latest') ) colabs_tabs_latest($number, $thumb_size); ?>                    
                </ul>
